...
function FourPointOnPSphere(p1::Vec3D,p2::Vec3D,p3::Vec3D,p4::Vec3D)::PSphere
    plane_12 = SameDistancePPlane(p1,p2)
    plane_34 = SameDistancePPlane(p3,p4)

    line_12_34 = P2PIntersection(plane_12,plane_34)
    ...
    c = P2PIntersection(line_12_34,plane_23)
    if (isnothing(c))
        return PSphereNan
    end
