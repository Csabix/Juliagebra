...
Sphere(sun, ValueHolder(1.3); color=(0.902, 0.439, 0))

ParametricCurve(range(0.0,2*pi,100), [sun, o]; color=(0, 0.063, 0.729)) do t, sun, o
...
Sphere(earth, ValueHolder(0.65); color=(0, 0.063, 0.729))
