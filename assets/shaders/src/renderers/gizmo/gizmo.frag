...
layout(location = 0) noperspective in vec4 segment_SDF_field_g_out; // x,y,lenX,lenY; x in [0,lenX] y in [0,lenY]
layout(location = 1) flat          in vec3 color_g_out;
layout(location = 2) flat          in uint id_g_out;
